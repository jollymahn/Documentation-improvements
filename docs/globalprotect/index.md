...
### Branching Guide
Decision-point format with expandable sections. Best when you need to choose between multiple authentication methods, tunneling strategies, or multi-gateway architectures.

[Open Branching Guide](branching-guide.md)
